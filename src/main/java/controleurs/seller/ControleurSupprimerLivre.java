...
public class ControleurSupprimerLivre implements EventHandler<ActionEvent> {
    /** La carte du livre */
    private BookCardDeleteComponentSeller component;
     ...
     */
    public ControleurSupprimerLivre(BookCardDeleteComponentSeller component, ChaineLibrairie modele, Livre livre) {
