...
public class SellerListBook implements MAJVueInterface {
    /** La vue principal */
    private SellerHomeView sellerView;
    /** Le modèle */
     ...
     */
    public SellerListBook(SellerHomeView sellerView, ChaineLibrairie modele, List<Livre> listeLivres) {
        ...
        HBox header = this.sellerView.getHeader();
