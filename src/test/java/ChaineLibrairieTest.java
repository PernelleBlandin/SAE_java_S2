...
public class ChaineLibrairieTest {
    ...
    // Client 1
    private Panier panierClient1 = new Panier(1, this.magasinOrleans, new ArrayList<>());
    ...
    private Panier panierClient2 = new Panier(2, this.magasinMarseille, new ArrayList<>());
    ...
    private Panier panierClient3 = new Panier(3, this.magasinOrleans, new ArrayList<>(Arrays.asList(this.detailCommande4)));
    ...
    private Panier panierClient4 = new Panier(4, this.magasinParis, new ArrayList<>(Arrays.asList(this.detailCommande5)));
    ...
    private Panier panierClient5 = new Panier(5, this.magasinParis, new ArrayList<>());
    ...
    private Panier panierClientInconnu = new Panier(666, this.magasinParis, new ArrayList<>());
